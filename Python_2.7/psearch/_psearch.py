...
def ParseCommandLine():
    ...
    parser.add_argument('-k', '--keywords', type=ValidateFileRoad, required=True, help="specify the file containing search words")
    parser.add_argument('-t', '--srchTarget', type=ValidateFileRoad, required=True, help="specify the target file to search")
    parser.add_argument('-m', '--theMatrix', type=ValidateFileRoad, required=True, help="specify the weighted matrix file")
